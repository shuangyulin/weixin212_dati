      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '用户手机' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.yonghushouji" placeholder="用户手机" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.yonghushouji" placeholder="用户手机" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.yonghushouji" placeholder="用户手机" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '邮箱' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.youxiang" placeholder="邮箱" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.youxiang" placeholder="邮箱" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.youxiang" placeholder="邮箱" clearable></el-input>
                </el-form-item>
          <el-form-item>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.yonghushouji!='' && this.searchForm.yonghushouji!=undefined){
            params['yonghushouji'] = '%' + this.searchForm.yonghushouji + '%'
          }
          if(this.searchForm.youxiang!='' && this.searchForm.youxiang!=undefined){
