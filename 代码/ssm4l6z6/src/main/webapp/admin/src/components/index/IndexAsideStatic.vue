      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(123, 193, 136, 1)"
          })
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: rgba(159, 111, 85, 1) !important;
		...
		&>.el-menu-item {
			...
			background-color: rgba(159, 111, 85, 1) !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			background-color: rgba(159, 111, 85, 1);
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    padding: 0 0 0 20px !important;
                    margin: 0;
                    color: rgba(103, 196, 21, 1) !important;
                    font-size: 14px;
                    border-radius: 0;
                    border-width: 0;
                    border-style: solid;
